            ...
            {/* login form  */}
               <form onSubmit={handleSubmit} className="space-y-6">
                   ...
                   <div className='relative'>
                    ...
                    <input type='email' className='w-full border border-gray-300 rounded-md py-2 pl-10 pr-3 focus:outline-none focus:ring-2 focus:ring-blue-500' placeholder="you@gmail.com" value={formData.email} onChange={(e)=>{
                   ...
                   <div className='relative'>
                    ...
                    <input type={showPassword ? "text" : "password"} className='w-full border border-gray-300 rounded-md py-2 pl-10 pr-3 focus:outline-none focus:ring-2 focus:ring-blue-500' placeholder="********" value={formData.password} onChange={(e)=>{
